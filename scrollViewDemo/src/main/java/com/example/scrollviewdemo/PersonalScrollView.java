...
public class PersonalScrollView extends ScrollView {
    ...
    public void commOnTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                initTouchY = ev.getY();
                current_Top = initTop = headerView.getTop();
                current_Bottom = initBottom = headerView.getBottom();
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isMoveing) {
                    ...
                    headerView.layout(headerView.getLeft(), current_Top,
                            headerView.getRight(), current_Bottom);
    ...
    public void animation() {
        ...
        headerView.startAnimation(image_Anim);

        headerView.layout(headerView.getLeft(),initTop,
                headerView.getRight(),  initBottom);
